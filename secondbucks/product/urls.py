...
urlpatterns = [
    ...
    url('^(?P<state_id>[0-9]+)/categories/$', views.category_list, name='categories'),

    #/state_name/category_name
    url('^(?P<state_id>[0-9]+)/(?P<category_id>[0-9]+)/$', views.category_wise, name='category_wise'),

    #/state_name/category_name/product_name/
    url('^(?P<state_id>[0-9]+)/(?P<category_id>[0-9]+)/(?P<product_id>[0-9]+)/$', views.product_details, name='product_details'),

    #/state/register/
    url('^state/register/$',views.RegisterState.as_view(),name='state-add'),
    ...
    url('^notify/(?P<state_id>[0-9]+)/(?P<category_id>[0-9]+)/$', views.notify, name='notify'),
